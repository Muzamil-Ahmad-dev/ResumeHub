...
import CreativeResumeForm from "@/components/creativeFrom/CreativeResumeForm";
import { FaArrowLeft } from "react-icons/fa"; 

/**
 * CreativeTemplates Page
 * -----------------------------------------------------------------------------
 * Page for displaying Creative Resume Templates.
 * - Users can select a template to start building their resume.
      ...
      >
        ...
        {selectedTemplate ? (
          <div className="bg-white rounded-2xl shadow-lg p-6">
            ...
            {/* -----------------------------------------------------------------
             * Back Button
             * - Allows user to return to template selection
             * -----------------------------------------------------------------
             */}
          ...
          <>
             ...
             * - Clickable card to select template
             * - Includes hover animations and image overlay
             * -----------------------------------------------------------------
             */}
            <div
              ...
              >
                ...
                <div className="p-4 text-center">
                  ...
                  <p className="text-gray-500 text-sm">
                    Click to start building your creative resume.
                  </p>
                </div>
              </motion.div>
            </div>
